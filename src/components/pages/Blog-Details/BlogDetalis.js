  ...
  return (
    <>
      ...
      <div className="container h-100">
        ...
        <div
          className="body row justify-content-center align-items-center h-150 text-center" 
        >
          <div className="blogbox col-12 mb-5 bg-white p-5 rounded rounded-4">
            ...
            <img
              ...
              />
            <h6 className="text-start col-12 mb-4 mt-5" >
            ...
            <h6 className="text-start col-12  mb-4">
            ...
            <h6 className="text-start col-12">
